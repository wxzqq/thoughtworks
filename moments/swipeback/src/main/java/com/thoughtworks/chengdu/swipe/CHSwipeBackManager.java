 ...
 * 描述:
 */
class CHSwipeBackManager implements Application.ActivityLifecycleCallbacks {
    private static final CHSwipeBackManager sInstance = new CHSwipeBackManager();
    private Stack<Activity> mActivityStack = new Stack<>();
    private Set<Class<? extends View>> mProblemViewClassSet = new HashSet<>();

    public static CHSwipeBackManager getInstance() {
        return sInstance;
    }

    private CHSwipeBackManager() {
    }
