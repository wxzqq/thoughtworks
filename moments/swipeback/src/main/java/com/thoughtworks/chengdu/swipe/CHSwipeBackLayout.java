 ...
 */
public class CHSwipeBackLayout extends ViewGroup {
     ...
     * 滑动返回时的阴影视图
     */
    private CHSwipeBackShadowView mShadowView;
    /**
     * 内容视图
     */
    ...
    void attachToActivity(Activity activity) {
        ...
        mShadowView = new CHSwipeBackShadowView(activity);
    ...
    private boolean isSwipeBackEnable() {
        return mSwipeBackEnable && CHSwipeBackManager.getInstance().isSwipeBackEnable();
    }
    ...
    public CHSwipeBackLayout(Context context) {
        this(context, null);
    }

    public CHSwipeBackLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CHSwipeBackLayout(Context context, AttributeSet attrs, int defStyle) {
...
//            mDragHelper.captureChildView(mSlideableView, pointerId);
    ...
    interface SlidingPanelLayoutImpl {
        void invalidateChildRegion(CHSwipeBackLayout parent, View child);
    }

    static class SlidingPanelLayoutImplBase implements SlidingPanelLayoutImpl {
        @Override
        public void invalidateChildRegion(CHSwipeBackLayout parent, View child) {
    ...
    class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
            ...
            info.setClassName(CHSwipeBackLayout.class.getName());
            info.setSource(host);
        ...
        public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
            ...
            event.setClassName(CHSwipeBackLayout.class.getName());
        }
