...
/**
 * Created by GB on 16/9/6.
 */

public class NetStateProvider {
    ...
    public NetStateProvider(Context context) {
        mContext = context;
    }
    ...
    private int getNetworkClass() {
        ...
        try {
            final NetworkInfo network = ((ConnectivityManager) mContext.getSystemService(Context.CONNECTIVITY_SERVICE))
